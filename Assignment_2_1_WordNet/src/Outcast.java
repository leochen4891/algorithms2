...
public class Outcast {
    ...
    public String outcast(String[] nouns) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                //StdOut.println(nouns[i] + " and " + nouns[j] + " ---> " + dist);
    ...
    public static void main(String[] args) {
        ...
        String[] strs2 = "water soda bed orange_juice milk apple_juice tea coffee".split(" ");
        String[] strs3 = "apple pear peach banana lime lemon blueberry strawberry mango watermelon potato".split(" ");
        ...
        ret = outcast.outcast(strs3);
        StdOut.println("3:" + ret);
    }
}
