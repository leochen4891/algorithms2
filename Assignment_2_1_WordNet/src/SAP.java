public class SAP {
 ...
 // constructor takes a digraph (not necessarily a DAG)
    ...
    private int findAncestor(Queue<Integer> qv, Queue<Integer> qw) {
        int qvSize = qv.size();
        int qwSize = qw.size();
        int cur;
        int dist;
        int maxDistV = -1;
        int maxDistW = -1;
        // replace items in qv and qw with their adjacents, and update distance array
        ...
        if (possibleAncestor >= 0 && maxDistV >= possibleLength && maxDistW >= possibleLength) {
